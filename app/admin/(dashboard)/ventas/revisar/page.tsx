 ...
 * apartado que diga Ventas... yo confirmo o deniego"; movida a esta
 * ruta el mismo día, pedido explícito: "el inicio de este panel es
 * todo el analytics, y este debe tener otra pestaña... que es ver las
 * ventas así las sincronizo" — ver /admin/ventas para la analítica).
 * Cada fila viene de app/api/ventas-sync/route.ts (el webhook que
 * alimenta esto automáticamente, ver migración 0036) con una
 * sugerencia de a qué lead/campaña corresponde — acá se confirma o se
 * busca a mano.
 */
